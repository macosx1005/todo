@extends('layouts.app')
@section('content')
    <div class="w-110 h-100 d-flex justify-content-center align-items-center">
        <div class="text-center" style="width: 40%">
        
            <h1 class="display-2 text-black">
                  Todo App
            </h1>
            <h2 class="text-black pt-5" >What next? Add something to your list!</h2>
            ...
            <h2 class="text-black pt-2">My Todo list:</h2>
                      ...
                      <button class="btn btn-success">Mark it as Completed</button>
                        ...
                        @else 
                            <form action="{{route('todo.update', $todo->id)}}" method="POST">
                              ...
                              <button class="btn btn-worning">Mark it as Uncompleted</button>
                            </form>
